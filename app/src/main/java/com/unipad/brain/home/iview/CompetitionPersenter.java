...
//				holder.setTextColor(R.id.txt_name, homeBean.isSelect ? iHome.getContext().getResources().getColor(R.color.main_1) : iHome.getContext().getResources().getColor(R.color.black));
	...
	private void selCompetitiomAt(){
		if( null != projectBean)
		if(ConstSettings.getProjectValues(iCompetition.getContext()).get(0).equals(projectBean.getName())){
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(1).equals(projectBean.getName())){
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(2).equals(projectBean.getName())){
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(3).equals(projectBean.getName())){
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(4).equals(projectBean.getName())){
			// 跳入快速随机数字 比赛项目 界面
			iCompetition.getContext().startActivity(new Intent(iCompetition.getContext(),RapidRandomNumberActivity.class));
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(5).equals(projectBean.getName())){
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(6).equals(projectBean.getName())){
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(7).equals(projectBean.getName())){
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(8).equals(projectBean.getName())){
			
		} else if(ConstSettings.getProjectValues(iCompetition.getContext()).get(9).equals(projectBean.getName())){
